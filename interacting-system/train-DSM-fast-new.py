...
def main(args: argparse.Namespace) -> None:
    ...
    if d == 2:
        if args.models_dir == "":
            models_dir="dsm_harm_osc_interact_g={}_T={}_hdim={}_eps={}_batch={}_lr={}_N={}_arch_{}_sample_{}".format(g, T, args.dim_hid, args.n_epochs,
                                                                                    args.batch, args.lr, args.N, args.nn_architecture, sampling_type)
        else:
            models_dir="dsm_harm_osc_interact_g={}_T={}_hdim={}_eps={}_batch={}_lr={}_N={}_arch_{}_sample_{}_{}".format(g, T, args.dim_hid, args.n_epochs,
                                                                                    args.batch, args.lr, args.N, args.nn_architecture, sampling_type, args.models_dir)
    else:
        if args.models_dir == "":
            models_dir="dsm_harm_osc_interact_d={}_g={}_T={}_hdim={}_eps={}_batch={}_lr={}_N={}_arch_{}_sample_{}".format(d, g, T, args.dim_hid, args.n_epochs,
                                                                                    args.batch, args.lr, args.N, args.nn_architecture, sampling_type)
        else:
            models_dir="dsm_harm_osc_interact__d={}_g={}_T={}_hdim={}_eps={}_batch={}_lr={}_N={}_arch_{}_sample_{}_{}".format(d, g, T, args.dim_hid, args.n_epochs,
                                                                                    args.batch, args.lr, args.N, args.nn_architecture, sampling_type, args.models_dir)
